...
{
    public partial class SnakeGamePage : Form
    {
        ...
        private void move(object sender, EventArgs e)
        {
            ...
            if(game_over(x+dx, y + dy))
            {
                ...
                // return;
                SnakeAgreement sa = new SnakeAgreement();
        ...
        private bool hits(int x, int y)
        {
            ...
            {
                timer.Stop();
                MessageBox.Show("Snake Hits its Body\nYour Score: " + score.ToString());
                // return true;
                SnakeAgreement sa = new SnakeAgreement();
                // MainForm mf = new MainForm();
                sa.Show();
        ...
        private void SnakeGamePage_Load(object sender, EventArgs e)
        {
